...
uint256 hashGenesisBlock("0xe6e670163e2fce920455b43d3e545fdfdb60e3fee4dcfb60e3fee4dcfb141271e060b95f9fa1");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // calcoin: 1 days
static const int64 nTargetSpacing = 120; // calcoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1414963616; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4346968;
        ...
        assert(block.hashMerkleRoot == uint256("0xa3dfbf2586d785e6a350e508d6a8327e005c840d712dabdc21898d5ae5f96a16"));
