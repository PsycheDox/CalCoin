...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake USE_UPNP=1 USE_QRCODE=1 USE_IPV6=1 -o Makefile calcoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lqrencode -lminiupnpc /home/psychedox/calcoinlinuxqt/CalCoin/src/leveldb/libleveldb.a /home/psychedox/calcoinlinuxqt/CalCoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Network -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
...
Makefile: calcoin-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_UPNP=1 USE_QRCODE=1 USE_IPV6=1 -o Makefile calcoin-qt.pro
