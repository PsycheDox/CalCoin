...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=41313           " + _("Listen for connections on <port> (default: 9333 or testnet: 19333)") + "\n" +
        ...
        "  -rpcport=41312        " + _("Listen for JSON-RPC connections on <port> (default: 9332 or testnet: 19332)") + "\n" +
