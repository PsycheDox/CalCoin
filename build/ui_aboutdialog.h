...
"Copyright &copy; 2011-YYYY The CalCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About CalCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>CalCoin</b> version", 0));
