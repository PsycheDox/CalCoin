...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "CalCoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "CalCoin Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the CalCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the CalCoin-Qt help message to get a list with possible CalCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
