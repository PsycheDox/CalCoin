...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to calcoin server / RPC client
            std::string strUsage = _("calcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  calcoin [options]                     " + "\n" +
                  "  calcoin [options] <command> [params]  " + _("Send command to -server or calcoin") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=41313           " + _("Listen for connections on <port> (default: 41313 or testnet: 45884)") + "\n" +
        ...
        "  -rpcport=41312>        " + _("Listen for JSON-RPC connections on <port> (default: 41312)") + "\n" +
...
//    }
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s.  calcoin is probably already running."), GetDataDir().string().c_str()));
